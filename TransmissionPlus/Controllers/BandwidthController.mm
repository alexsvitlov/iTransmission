...
- (void)overrideGlobalLimitsEnabledValueChanged:(id)sender
{
    ...
    [self.torrent setUsesGlobalSpeedLimit:!enabled];
...
- (void)viewDidLoad
{
    ...
    if (self.torrent) {
        ...
        [fUploadSpeedLimitField setText:[NSString stringWithFormat:@"%ld", (long)[self.torrent speedLimit:YES]]];
        [fDownloadSpeedLimitField setText:[NSString stringWithFormat:@"%ld", (long)[self.torrent speedLimit:NO]]];
        [self enableOrDisableLimitCells];
    }
    else {
