...
{
    return [self relativePathFromBaseDirPath:[(AppDelegate*)[UIApplication sharedApplication].delegate documentsDirectory]];
}

- (NSString *)absolutePathFromDocumentDirectory
{
    return [self absolutePathFromBaseDirPath:[(AppDelegate*)[UIApplication sharedApplication].delegate documentsDirectory]];
}
